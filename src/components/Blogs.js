                ...
                <div class="row">
                        ...
                        <div class="card bg-dark text-white">
                            ...
                            <div class="card-img-overlay d-flex flex-column justify-content-end">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="author">
                                        <img alt="Author Benjamin" height="30" src="https://storage.googleapis.com/a1aa/image/nrQsdjvNArLMF1oEZsjNWrsl1G4O3LAiwDEs0112ATOUHTfJA.jpg" width="30" />
                                        <small class="text-muted">
                                            Benjamin
                                        </small>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card bg-dark text-white mb-4">
                            <img alt="Person preparing healthy food" class="card-img" height="200" src="https://storage.googleapis.com/a1aa/image/6avxGEhbdYIwB5ApBnHuuFc7h5qf6FYfsoMsRxw1Cafo6Y6nA.jpg" width="400" />
                            <div class="card-img-overlay d-flex flex-column justify-content-end">
                        ...
                        <div class="card bg-dark text-white">
                            <img alt="Healthy food with vegetables and meat" class="card-img" height="200" src="https://storage.googleapis.com/a1aa/image/TnVYpiafeZmt1UaHxReM70HFNerij2BKNFQFPPOt3OX60x0PB.jpg" width="400" />
                            <div class="card-img-overlay d-flex flex-column justify-content-end">
